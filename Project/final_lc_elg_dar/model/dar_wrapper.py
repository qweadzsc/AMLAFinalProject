...
def compute_dar_bias(coordinates: torch.Tensor, current_node: torch.Tensor, ninf_mask: torch.Tensor, dar_k: int, dar_log_nearest: bool) -> torch.Tensor:
    ...
    nearest_bias = -torch.log(dist) if dar_log_nearest else -dist
    far_bias = -dist
